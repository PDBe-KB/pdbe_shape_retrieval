...
import shape_utils.models as models
...
# Main Function
def calculate_similarity_score(models_zernike,input_dir,atom_type, cuda = 'true', model_type = 'neural_network', device_id = 0):
    ...
    if model_type == 'neural_network':
        ...
        model_file = os.path.join(models_zernike,model_name)
        print('Neural Network Model')
        print('GDL:', model_file)
        if isfile(model_file):
            ...
            if cuda:
                ...
                model.to(device_id)
                print('hello',model)
            print(model_file + ' Loaded and will be used for evaluation')
        else:
